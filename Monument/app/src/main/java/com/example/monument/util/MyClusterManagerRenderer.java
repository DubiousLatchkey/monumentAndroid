package com.example.monument.util;
...
public class MyClusterManagerRenderer extends DefaultClusterRenderer<ClusterMarker>
{
    ...
    public MyClusterManagerRenderer(Context context, GoogleMap googleMap,
        ...
        markerWidth = (int) context.getResources().getDimension(R.dimen.activity_horizontal_margin);
        markerHeight = (int) context.getResources().getDimension(R.dimen.activity_vertical_margin);
